...
app.use((0, crudRoutes_1.default)(models_1.Document, "document", "workspaceId", "workspace"));
app.use((0, crudRoutes_1.default)(models_1.Category, "category"));
app.use((0, crudRoutes_1.default)(models_1.User, "users"));
app.use((0, crudRoutes_1.default)(models_1.File, "files"));
